...
_NOTE_RULES = [
    ...
    ("Independent transfers", re.compile(r"\b(self[- ]arranged|meeting points?|stations?|airports?)\b", re.I)),
    ("Winter travel conditions", re.compile(r"\b(winter|road|rail conditions|local guidance|extra time)\b", re.I)),
