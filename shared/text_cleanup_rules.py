...
SUPPLIER_TYPO_PATTERNS: tuple[tuple[str, str, str], ...] = (
    ...
    (r"\bvehcile\b", "vehicle typo leaked", "error"),
    (r"\botherwordly\b", "otherworldly typo leaked", "error"),
    ...
    (r"\btranfser\b", "transfer typo leaked", "error"),
    (r"\bKussamo\b", "Kuusamo typo leaked", "error"),
    (r"\bCluas\b", "Claus typo leaked", "error"),
