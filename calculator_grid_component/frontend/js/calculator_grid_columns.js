const CALCULATOR_COLUMNS = [
  ...
  {key: 'travel_element', label: 'Travel element', kind: 'text', minWidth: 260, maxWidth: 380, fitChars: 42, autocomplete: true},
  ...
  {key: 'url', label: 'URL', kind: 'url', minWidth: 140, maxWidth: 220, fitChars: 30},
