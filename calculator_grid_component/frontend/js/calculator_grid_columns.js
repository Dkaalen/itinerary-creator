const CALCULATOR_COLUMNS = [
  ...
  {key: 'gross_price_per_unit', label: 'Gross P per unit', kind: 'number', minWidth: 108, maxWidth: 122, fitChars: 10},
  {key: 'units', label: 'Units', kind: 'number', minWidth: 58, maxWidth: 70, fitChars: 5},
  {key: 'gross_price', label: 'Gross P', kind: 'formula', minWidth: 76, maxWidth: 104, fitChars: 11, formula: true},
  {key: 'supplier_commission', label: 'Supp Comm', kind: 'percent', minWidth: 82, maxWidth: 94, fitChars: 7},
  {key: 'net_price', label: 'Net P', kind: 'formula', minWidth: 68, maxWidth: 104, fitChars: 11, formula: true},
  ...
  {key: 'net_price_nok', label: 'Net P NOK', kind: 'formula', minWidth: 90, maxWidth: 122, fitChars: 13, formula: true},
  {key: 'sales_price_per_unit', label: 'Sales P per unit', kind: 'numberOptional', minWidth: 112, maxWidth: 130, fitChars: 11},
  {key: 'price', label: 'Price', kind: 'formula', minWidth: 74, maxWidth: 116, fitChars: 12, formula: true},
  ...
  {key: 'sales_price_nok_total', label: 'Sales P NOK tot', kind: 'formula', minWidth: 116, maxWidth: 142, fitChars: 13, formula: true},
  {key: 'gp_nok', label: 'GP NOK', kind: 'formula', minWidth: 72, maxWidth: 112, fitChars: 12, formula: true},
  {key: 'gp_percent', label: 'GP %', kind: 'formulaPercent', minWidth: 64, maxWidth: 82, fitChars: 7, formula: true},
