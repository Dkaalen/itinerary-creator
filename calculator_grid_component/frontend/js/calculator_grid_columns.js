const CALCULATOR_COLUMNS = [
  ...
  {key: 'travel_element', label: 'Travel element', kind: 'text', minWidth: 300, maxWidth: 520, fitChars: 64, autocomplete: true},
  ...
  {key: 'gross_price_per_unit', label: 'Gross P per unit', kind: 'number', minWidth: 124, maxWidth: 132, fitChars: 10},
  {key: 'units', label: 'Units', kind: 'number', minWidth: 62, maxWidth: 70, fitChars: 5},
  {key: 'gross_price', label: 'Gross P', kind: 'formula', minWidth: 78, maxWidth: 96, fitChars: 10, formula: true},
  {key: 'supplier_commission', label: 'Supp Comm', kind: 'percent', minWidth: 88, maxWidth: 98, fitChars: 7},
  {key: 'net_price', label: 'Net P', kind: 'formula', minWidth: 68, maxWidth: 92, fitChars: 10, formula: true},
  {key: 'supplier_currency', label: 'Supp curr', kind: 'text', minWidth: 84, maxWidth: 92, fitChars: 4},
  {key: 'supplier_x_rate', label: 'X-rate', kind: 'formula', minWidth: 68, maxWidth: 78, fitChars: 6, formula: true},
  {key: 'net_price_nok', label: 'Net P NOK', kind: 'formula', minWidth: 92, maxWidth: 112, fitChars: 12, formula: true},
  {key: 'sales_price_per_unit', label: 'Sales P per unit', kind: 'numberOptional', minWidth: 124, maxWidth: 132, fitChars: 10},
  {key: 'price', label: 'Price', kind: 'formula', minWidth: 64, maxWidth: 92, fitChars: 10, formula: true},
  {key: 'sales_currency', label: 'Sales curr', kind: 'text', minWidth: 84, maxWidth: 92, fitChars: 4},
  {key: 'sales_x_rate', label: 'X-rate', kind: 'formula', minWidth: 68, maxWidth: 78, fitChars: 6, formula: true},
  {key: 'sales_price_nok_total', label: 'Sales P NOK tot', kind: 'formula', minWidth: 118, maxWidth: 138, fitChars: 12, formula: true},
  {key: 'gp_nok', label: 'GP NOK', kind: 'formula', minWidth: 72, maxWidth: 100, fitChars: 11, formula: true},
  {key: 'gp_percent', label: 'GP %', kind: 'formulaPercent', minWidth: 62, maxWidth: 76, fitChars: 6, formula: true},
