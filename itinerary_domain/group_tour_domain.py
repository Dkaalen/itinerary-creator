...
from itinerary_domain.group_tour_models import (
    GroupTourAccommodationPolicy,
    GroupTourCommercialItem,
    GroupTourDay,
    GroupTourPackage,
)
from itinerary_domain.group_tour_builder import build_group_tour_package
from itinerary_domain.group_tour_master_rows import is_group_tour_master_row
from itinerary_domain.group_tour_serialization import (
...
from itinerary_domain.group_tour_builder import _package_id
...
from itinerary_domain.group_tour_text import (
    _clean,
    _clean_strings,
    _field,
    _infer_season,
