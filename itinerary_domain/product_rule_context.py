...
def product_context(row:dict|None=None,*values:object)->str:return " ".join(_values(row,("raw","display_title","title","original_title","details","description","city"))+[str(v) for v in values if v])
