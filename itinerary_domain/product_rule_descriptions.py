...
from itinerary_domain.fjordtours_activity_catalogue import fjordtours_activity_description
from itinerary_domain.product_rule_models import ProductConfidence
