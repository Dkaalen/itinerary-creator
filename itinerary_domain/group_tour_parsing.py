...
neutral :mod:`itinerary_domain.group_tour_domain` contract.  It deliberately
...
from itinerary_domain.group_tour_domain import (
    GroupTourPackage,
    annotate_group_tour_rows,
    group_tour_day_from_row,
    group_tour_package_from_row,
)
from itinerary_domain.group_tour_orphan_days import annotate_orphan_group_tour_days
