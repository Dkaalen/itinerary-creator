...
def test_gudvangen_is_valid_explicit_nutshell_destination() -> None:
...
def test_includes_only_gudvangen_does_not_override_bergen_destination() -> None:
...
def test_without_explicit_title_uses_complete_route_endpoint_not_first_leg() -> None:
...
def test_geilo_is_known_nutshell_route_place() -> None:
...
def test_fjordtours_nutshell_addon_catalogue_has_official_core_fields() -> None:
...
def test_fjordtours_addon_matching_uses_curated_titles_and_descriptions() -> None:
    row = {
        "city": "Flåm",
...
def test_fjordtours_addon_catalogue_matches_key_activities() -> None:
    samples = {
