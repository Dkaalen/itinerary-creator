...
def test_groups_warnings_and_uses_export_check_language():
...
def test_warning_payloads_include_metadata_for_grouping():
    payload = {
...
def test_warning_count_ignores_hidden_autofix_bucket():
    source = read_contract_text("visual_editor_component/frontend/js/editor_warnings.js")
