...
def test_app_bootstrap_avoids_full_project_io_import() -> None:
    source = (ROOT / "app.py").read_text(encoding="utf-8")
    assert "from app_modules.workflow_state import ensure_workflow_defaults" in source
    assert "from app_modules.project_io import initialise_state" not in source
