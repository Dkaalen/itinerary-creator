...
def test_norway_nutshell_titles_preserve_supplier_destination() -> None:
...
def test_norway_nutshell_supplier_legs_are_rendered() -> None:
    rows, grouped = _rows_and_grouped()
...
def test_strong_supplier_activity_titles_and_floibanen_wording() -> None:
    rows, grouped = _rows_and_grouped()
    context = build_itinerary_render_context(rows, grouped, {})
...
def test_cover_and_summary_images_share_preview_pdf_state() -> None:
    rows, grouped = _rows_and_grouped()
...
def test_cover_image_edits_are_persisted(monkeypatch) -> None:
...
def test_text_formatting_sidebar_is_visible_and_wired() -> None:
    ...
    debug_shell_js = read_contract_text("visual_editor_component/frontend/js/editor_debug_shell.js")
    inspector_js = (
        read_contract_text("visual_editor_component/frontend/js/editor_inspector.js")
        + "\n"
        + read_contract_text("visual_editor_component/frontend/js/editor_inspector_text_panel.js")
    )
