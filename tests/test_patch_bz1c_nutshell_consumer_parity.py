...
def test_bz1c_structured_inclusions_use_contract_title_source_identity_and_services() -> None:
...
def test_bz1c_discontinuous_supplier_legs_are_not_reordered_or_rendered_as_route_highlights() -> None:
    rows, grouped, nutshell_row = _real_state()
...
def test_bz1c_normalized_timetable_contract_drives_route_highlights_without_reparsing() -> None:
