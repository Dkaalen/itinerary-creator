...
def test_sidebar_exposes_controlled_presets_not_freeform_styles():
    inspector_js = (
...
def test_pdf_renders_controlled_text_presets():
    soup = BeautifulSoup(
...
def test_pdf_renders_note_and_divider_blocks():
    soup = BeautifulSoup(
