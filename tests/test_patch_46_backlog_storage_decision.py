...
def test_patch_46_keeps_project_file_as_only_enabled_storage_mode() -> None:
...
def test_patch_46_storage_decision_remains_cloud_ready_without_enabling_cloud_storage() -> None:
...
def test_patch_46_project_file_payload_has_no_backlog_or_search_index_storage() -> None:
...
def test_patch_46_project_file_guard_rejects_accidental_backlog_payload() -> None:
    try:
