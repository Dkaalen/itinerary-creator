...
def test_scan_cache_key_tracks_nested_file_size_even_when_mtime_is_unchanged(tmp_path):
...
def test_runtime_image_bank_setup_returns_failure_diagnostics(monkeypatch, tmp_path):
...
def test_image_bank_debug_payload_and_summary_are_copyable(tmp_path):
    bank = tmp_path / "image_bank_full"
...
def test_match_debug_includes_score_breakdown():
