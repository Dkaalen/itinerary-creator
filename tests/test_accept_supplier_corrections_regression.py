...
def test_builds_safe_accept_actions_for_parser_type_corrections():
    rows = [
        {
            "day": "Day 7",
            "type": "Criuse",
...
def test_applies_safe_parser_corrections_without_touching_human_review_rows():
    rows = [
        {
            "day": "Day 7",
            "type": "Criuse",
...
def test_correction_table_is_user_actionable_not_debug_payload():
...
def test_ui_exposes_single_accept_button_without_nested_expanders():
