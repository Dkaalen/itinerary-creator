...
def test_frontend_registry_matches_python_registry():
    assert _frontend_registry() == style_preset_registry()


def test_controlled_classes_have_single_registry_source():
...
def test_frontend_uses_registry_for_toolbar_and_sanitizer():
    ...
    text_formatting_js = read_contract_text("visual_editor_component/frontend/js/editor_text_formatting.js")
...
def test_pdf_uses_registry_for_controlled_classes():
    render_content = read_contract_text("pdf_exporter_modules/render_content.py")
...
def test_block_templates_remain_controlled_html():
