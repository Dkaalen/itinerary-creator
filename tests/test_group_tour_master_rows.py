...
def test_group_tour_pickup_time_helper_has_single_neutral_owner() -> None:
    ...
    generation_facade = read_contract_text("itinerary_generation/group_tour_master_rows.py")
    ...
    assert '_import_module("itinerary_domain.group_tour_master_rows")' in generation_facade
