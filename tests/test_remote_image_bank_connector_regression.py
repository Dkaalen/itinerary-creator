...
def test_remote_zip_connector_installs_separate_image_bank_when_git_is_missing(monkeypatch, tmp_path):
...
def test_remote_bank_beats_bundled_default_after_connection(monkeypatch, tmp_path):
    root = tmp_path / "itinerary-creator-git"
...
def test_image_status_message_points_to_separate_remote_repo(tmp_path):
...
def test_same_destination_selection_prioritizes_season_before_activity_noise(tmp_path):
