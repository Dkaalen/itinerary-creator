...
def test_input4_chooses_earliest_supplier_prose_boundary():
    item = _item(
        "Activity",
...
def test_input4_compacts_repeated_subject_activity_descriptions():
    item = _item(
        "Activity",
...
def test_input4_compacts_vipin_transport_and_rental_titles():
    rows = [
        _item(
            "Transfer",
...
def test_input4_compacts_remaining_real_corpus_title_shapes():
    rows = [
        _item(
            "Hotel",
