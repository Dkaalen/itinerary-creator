...
def test_bz1b_normalizer_attaches_versioned_contract_with_source_and_commercial_state() -> None:
...
def test_bz1b_timetable_contract_preserves_order_modes_and_times() -> None:
...
def test_bz1b_partial_source_keeps_known_legs_without_inventing_times() -> None:
    source = (
...
def test_bz1b_conflicting_supplier_chain_is_reported_not_silently_repaired() -> None:
...
def test_bz1b_legacy_title_entry_points_use_the_same_contract_title() -> None:
    source = (
...
def test_bz1b_contract_metadata_round_trip_is_lossless() -> None:
...
def test_bz1b_contract_rejects_wrong_kind_or_version() -> None:
...
def test_bz1b_non_nutshell_rows_do_not_receive_a_domain_contract() -> None:
...
def test_bz1b_explicit_non_nutshell_product_identity_wins_over_route_markers() -> None:
    raw = (
