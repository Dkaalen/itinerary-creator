...
TOTAL_FORMULAS = {
    f"Z{TOTALS_ROW}": f"=ROUND(SUM(Z{DATA_START_ROW}:Z{DATA_END_ROW}),2)",
    f"AC{TOTALS_ROW}": f"=ROUND(SUM(AC{DATA_START_ROW}:AC{DATA_END_ROW}),2)",
    f"AD{TOTALS_ROW}": f"=ROUND(SUM(AD{DATA_START_ROW}:AD{DATA_END_ROW}),2)",
    f"AE{TOTALS_ROW}": f"=IFERROR(AD{TOTALS_ROW}/AC{TOTALS_ROW},0)",
    f"AF{TOTALS_ROW}": f"=ROUND(SUM(AF{DATA_START_ROW}:AF{DATA_END_ROW}),2)",
    f"AG{TOTALS_ROW}": f"=ROUND(SUM(AG{DATA_START_ROW}:AG{DATA_END_ROW}),2)",
    f"AH{TOTALS_ROW}": f"=ROUND(SUM(AH{DATA_START_ROW}:AH{DATA_END_ROW}),2)",
    f"AI{TOTALS_ROW}": f"=ROUND(SUM(AI{DATA_START_ROW}:AI{DATA_END_ROW}),2)",
    f"AJ{TOTALS_ROW}": f"=ROUND(SUM(AJ{DATA_START_ROW}:AJ{DATA_END_ROW}),2)",
}
PAYMENT_FORMULAS = {
    "Z106": "=Z103-Z107",
    "Z109": "=Z103*0.3",
