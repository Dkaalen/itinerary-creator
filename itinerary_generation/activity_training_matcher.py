...
from itinerary_generation.activity_training_model import ActivityTrainingEntry,IndexedActivityTrainingEntry
from itinerary_generation.activity_training_text import normalize_training_text,training_tokens
