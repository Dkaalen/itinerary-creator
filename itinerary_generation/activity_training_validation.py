...
import csv,re
from itinerary_generation.activity_training_loader import DATA_PATH
from itinerary_generation.activity_training_text import field_from_details,normalize_training_text,title_from_details
