"""Compatibility facade for :mod:`itinerary_domain.activity_product_rules.scandinavia`.
...
_impl = _import_module("itinerary_domain.activity_product_rules.scandinavia")
