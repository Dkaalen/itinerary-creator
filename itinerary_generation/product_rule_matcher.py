...
from itinerary_generation.product_rule_context import product_context,product_context_lower
...
from itinerary_generation.product_rule_models import ProductConfidence,ProductRuleMatch,RULE_BY_ID
