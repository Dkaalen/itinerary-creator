...
from itinerary_generation.nutshell_constants import NUTSHELL_CANONICAL_FAMILY, NUTSHELL_CONTRACT_KIND
from itinerary_generation.nutshell_parsing import _is_norway_in_a_nutshell_text
