...
LANDMARKS: list[tuple[str, str]] = [
    ...
    ("Hauganes", r"Hauganes"),
    ("Glaumbær", r"Glaumb[æa]r"),
    ("Borgarvirki", r"Borgarvirki"),
    ("Hvítserkur", r"Hv[íi]tserkur"),
    ("Kolugljúfur", r"Koluglj[úu]fur"),
    ("Grábrók", r"Gr[áa]br[óo]k"),
    ("Glanni waterfall", r"Glanni"),
    ("Sturlureykir", r"Sturlureykir"),
    ("Dimmuborgir", r"Dimmuborgir"),
    ("Skútustaðagígar", r"Sk[úu]tusta[ðd]ag[íi]gar"),
    ("Vök Baths", r"V[öo]k Baths"),
    ("Stuðlagil Canyon", r"Stu[ðd]lagil"),
    ("Fjaðrárgljúfur canyon", r"Fja[ðd]r[áa]rglj[úu]fur"),
    ...
    ("Kiruna", r"Kiruna"),
    ("Oslo Opera House", r"Oslo Opera House"),
    ("Göteborg Opera House", r"G[öo]teborg Opera House|Göteborg Opera House"),
    ("Karl Johans gate", r"Karl Johans gate"),
    ("Oslo Cathedral", r"Domkirke|Oslo Cathedral"),
    ("Stortinget", r"Stortinget|Parliament building"),
    ("National Theatre", r"National Theat(?:er|re)"),
    ("Royal Palace", r"Royal Palace"),
    ("Oslo City Hall", r"Oslo City Hall|Oslo Hall"),
    ("Gothenburg City Hall", r"Gothenburg City Hall|Göteborg City Hall|City Hall"),
    ("Akershus Fortress", r"Akershus fortress"),
