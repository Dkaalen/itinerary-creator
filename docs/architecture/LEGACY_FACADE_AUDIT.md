...
Production modules scanned: 716
Facade-like modules: 147
Modules with no production importers: 104
...
- `itinerary_generation/summaries.py` — importers: 9
...
- `text_polish_modules/text_cleanup_rules.py` — importers: 1
