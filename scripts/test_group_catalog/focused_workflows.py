...
CALCULATOR_BROWSER_WORKFLOW_TESTS = (
    ...
    'tests/test_calculator_browser_navigation_and_focus.py::test_arrow_and_tab_navigation_follow_grid_geometry',
    ...
    'tests/test_calculator_browser_clipboard_and_paste.py::test_single_copied_value_broadcasts_to_shift_selected_rows_and_undoes_once',
    'tests/test_calculator_browser_clipboard_and_paste.py::test_copied_rectangle_repeats_across_a_compatible_selected_rectangle',
    'tests/test_calculator_browser_clipboard_and_paste.py::test_fill_shortcuts_distinguish_repeated_values_from_numbered_sequences',
    'tests/test_calculator_browser_clipboard_and_paste.py::test_fill_handle_continues_a_day_number_sequence',
    'tests/test_calculator_browser_clipboard_and_paste.py::test_internal_formula_copy_translates_even_when_browser_keeps_only_plain_text',
    'tests/test_calculator_browser_clipboard_and_paste.py::test_large_range_paste_recalculates_and_records_history_once',
    ...
    'tests/test_calculator_browser_formulas_and_currencies.py::test_trip_start_shifts_linked_dates_and_preserves_locked_dates_with_one_undo',
    'tests/test_calculator_browser_formulas_and_currencies.py::test_manual_date_edit_locks_cell_and_link_dates_rejoins_trip_sequence',
    'tests/test_calculator_browser_formulas_and_currencies.py::test_dashboard_presents_eur_first_and_retains_nok_as_secondary_context',
    'tests/test_calculator_browser_formulas_and_currencies.py::test_editing_day_one_date_updates_trip_start_and_all_linked_dates',
    ...
    'tests/test_calculator_browser_drafts_and_recovery.py::test_local_draft_restores_trip_start_and_date_link_ownership',
    ...
    'tests/test_calculator_browser_drafts_and_recovery.py::test_budget_prunes_old_versions_before_current_draft',
    'tests/test_calculator_browser_drafts_and_recovery.py::test_oversized_draft_shows_one_quiet_unavailable_status',
    'tests/test_calculator_browser_drafts_and_recovery.py::test_legacy_recovery_arrays_remain_readable',
    'tests/test_calculator_browser_recovery_storage_resilience.py::test_unavailable_indexeddb_does_not_interrupt_calculator_editing',
    'tests/test_calculator_browser_recovery_storage_resilience.py::test_failed_indexeddb_write_pauses_future_writes_without_repeated_status_refresh',
    'tests/test_calculator_browser_recovery_storage_resilience.py::test_failed_overwrite_restores_the_last_persisted_calculator_draft',
    'tests/test_calculator_browser_recovery_storage_resilience.py::test_clear_local_recovery_removes_only_owned_records_and_keeps_current_work',
    'tests/test_calculator_browser_recovery_storage_resilience.py::test_legacy_localstorage_migrates_to_indexeddb_and_stale_namespaces_are_removed',
    'tests/test_calculator_browser_recovery_storage_resilience.py::test_paired_recovery_versions_count_toward_global_namespace_budget',
    'tests/test_calculator_browser_recovery_storage_resilience.py::test_active_draft_growth_prunes_old_namespaces_after_write',
    'tests/test_calculator_browser_recovery_storage_resilience.py::test_clean_render_performs_no_recovery_write_until_first_edit',
    'tests/test_calculator_browser_recovery_storage_resilience.py::test_project_namespace_switch_keeps_recovery_isolated_and_restorable',
